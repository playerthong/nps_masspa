...
class Branch {
  ...
  Branch({this.serviceCode, this.branchCode, this.branchName, this.imageUrl, this.imageGallery, this.lat, this.lng, this.country, this.state, this.address, this.city, this.district, this.phone, this.mobile, this.countryCode, this.createdAt, this.isMain, this.updatedAt});
