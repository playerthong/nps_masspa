...
class LoginState extends BaseState<LoginScreen> {
                              ...
                              new Expanded(
                                child: TextFormField(
                                  ...
                                  onFieldSubmitted: (value){
                                    onFieldFocusChanged(context, usernameFocusNode, passwordFocusNode);
                                  },
                                ),
                              ),
                            ],
  ...
  void onFieldFocusChanged(BuildContext context, FocusNode currentFocus, FocusNode nextFocus) {
